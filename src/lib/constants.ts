export const ESPORTES = [
  ...
  { value: 'futevolei', label: 'Futevôlei', emoji: '🦶', cor: '#c2410c', bg: '#ffedd5', text: '#9a3412' },
  ...
  { value: 'ciclismo', label: 'Ciclismo', emoji: '🚴', cor: '#0284c7', bg: '#e0f2fe', text: '#075985' },
  ...
  { value: 'skate', label: 'Skate', emoji: '🛹', cor: '#7c3aed', bg: '#ede9fe', text: '#4c1d95' },
  ...
  { value: 'peteca', label: 'Peteca', emoji: '🪶', cor: '#4d7c0f', bg: '#ecfccb', text: '#3f6212' },
  { value: 'patins', label: 'Patins', emoji: '🛼', cor: '#db2777', bg: '#fce7f3', text: '#9d174d' },
  { value: 'sup', label: 'Stand Up Paddle', emoji: '🏄', cor: '#0369a1', bg: '#e0f2fe', text: '#075985' },
  { value: 'handebol', label: 'Handebol', emoji: '🤾', cor: '#059669', bg: '#d1fae5', text: '#065f46' },
  { value: 'escalada', label: 'Escalada', emoji: '🧗', cor: '#57534e', bg: '#f5f5f4', text: '#44403c' },
